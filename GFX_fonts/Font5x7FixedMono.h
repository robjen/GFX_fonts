const uint8_t Bitmaps5x7FixedMono[] PROGMEM = {
  ...
  0x29, 0x44, 0x88, 0x00, 0xFE, 0x00, 0x89, 0x14, 0xA0, 0x00
};

const GFXglyph Glyphs5x7FixedMono[] PROGMEM = {
  {     0,   0,   1,   6,    0,    0 }   // ' '
 ,{     0,   1,   7,   6,    2,   -7 }   // '!'
 ,{     1,   3,   2,   6,    1,   -7 }   // '"'
 ,{     2,   5,   7,   6,    0,   -7 }   // '#'
...
(uint8_t  *)Bitmaps5x7FixedMono,(GFXglyph *)Glyphs5x7FixedMono,0x20, 0x7E, 7};
